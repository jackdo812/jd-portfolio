...
const ThumbNav = () => {
  ...
  return (
      ...
      <nav className="fixed bottom-0 left-0 z-50 w-full p-2 bg-green-100 sm:hidden">
          ...
          <li>
            <NavLink to="/">
              <div className={`flex flex-col items-center ${isActive("/") ? "text-orange-500" : "text-green-700"}`}>
                <svg className={`${isActive("/") ? "fill-orange-500" : "fill-green-700"}`} aria-hidden="true" role="img" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
          ...
          <li>
            <NavLink to="/projects">
              <div className={`flex flex-col items-center ${isActive("/projects") ? "text-orange-500" : "text-green-700"}`}>
                ...
                <span className="pt-1 text-sm font-bold">Projects</span>
              </div>
            </NavLink>
          </li>
          <li>
            <NavLink to="/experiences">
              <div className={`flex flex-col items-center ${isActive("/experiences") ? "text-orange-500" : "text-green-700"}`}>
                ...
                <span className="pt-1 text-sm font-bold">Experiences</span>
              </div>
            </NavLink>
          </li>
          <li>
            <NavLink to="/connect">
              <div className={`flex flex-col items-center ${isActive("/connect") ? "text-orange-500" : "text-green-700"}`}>
                ...
                <span className="pt-1 text-sm font-bold">Connect</span>
              </div>
            </NavLink>
          </li>
        </ul>
